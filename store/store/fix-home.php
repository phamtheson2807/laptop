  ...
  <div class="css-slider">
    ...
    <section class="slide slide-one">
      <div class="container">
        ...
        <h3 class="">Sửa chữa tại nhà<br>
            Đảm bảo thời gian - Giá thành hợp lý</h3>
            <p class="para  text ">"Đừng lo lắng khi máy tính của bạn gặp sự cố! Dịch vụ sửa máy tính tại nhà của chúng tôi sẽ giúp bạn giải quyết mọi vấn đề một cách nhanh chóng và tiện lợi. Với đội ngũ kỹ thuật viên chuyên nghiệp, chúng tôi cam kết sẽ đưa máy tính của bạn trở lại hoạt động ổn định và hiệu quả nhất. Bạn không cần phải lo lắng về việc mang máy tính đi đâu, chỉ cần đặt lịch và chúng tôi sẽ đến tận nhà để sửa chữa. Hãy để chúng tôi giúp bạn tiết kiệm thời gian và công sức, và đảm bảo máy tính của bạn luôn hoạt động tốt nhất!"</p>
...
function buyNow(serviceName) {
        // Add the product to the cart (similar to what you are already doing)
        // ...
