...
<html lang="en">
  <head>
    ...
    <title>Cửa hàng sửa chữa máy tính | Đăng ký</title>
                ...
                <div class="map-content-9 mt-lg-0 mt-4">
                    ...
                    <form method="post" name="signup" onsubmit="return checkpass();">
                        ...
                        <div style="padding-top: 30px;">
                            <label>Họ</label>
                            <input type="text" class="form-control" name="firstname" id="firstname" placeholder="Họ" required=""></div>
                           <div style="padding-top: 30px;">
                            <label>Tên</label>
                        ...
                        <div style="padding-top: 30px;">
                           ...
                           <input type="text" class="form-control" placeholder="Số điện thoại" required="" name="mobilenumber" pattern="[0-9]+" maxlength="10"></div>
                           <div style="padding-top: 30px;">
                            <label>Email</label>
                       ...
                       <div style="padding-top: 30px;">
                        <label>Xác nhận mật khẩu</label>
                            <input type="password" class="form-control" name="repeatpassword" placeholder="Xác nhận mật khẩu" required="true">
                        </div>

                        <button type="submit" class="btn btn-contact" name="submit">Đăng ký</button>
                    </form>
                </div>
    </div>
