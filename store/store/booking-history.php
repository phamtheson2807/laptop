...
<html lang="en">
  <head>
    ...
    <title>Cửa hàng sữa chữa máy tính | Lịch sử đặt lịch</title>
...
<td><a href="appointment-detail.php?aptnumber=<?php echo $row['AptNumber'];?>" class="btn btn-primary">Xem</a></td>
</tr><?php $cnt=$cnt+1; } ?>
