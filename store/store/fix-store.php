...
<html lang="en">
  <head>
    ...
    <title>Cửa hàng sửa chữa máy tính | Sửa chữa tại cửa hàng</title>
  ...
  <div class="css-slider">
    ...
    <section class="slide slide-one">
      <div class="container">
        ...
        <h3 class="">Sửa chữa tại cửa hàng<br>
            Tận tình - Chu đáo - Chuyên nghiệp</h3>
            <p class="para  text ">"Đến với cửa hàng máy tính của chúng tôi, bạn sẽ được phục vụ tận tình và chuyên nghiệp trong việc sửa chữa máy tính. Đội ngũ kỹ thuật viên giàu kinh nghiệm sẽ giúp bạn khắc phục mọi vấn đề kỹ thuật một cách nhanh chóng và hiệu quả. Hãy để chúng tôi giúp bạn giữ cho máy tính của bạn luôn hoạt động tốt nhất!"</p>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 propClone">
                 <img src="admin/images/<?php echo $row['Image']?>" alt="product" height="200" width="400" class="img-responsive about-me">
                    <div class="about-grids ">
                        ...
                        <button type="button" onclick="buyNow('<?php echo $row['ServiceName']; ?>')">Mua ngay</button>
                    </div>
                </div>
                <br><?php
$cnt=$cnt+1;
