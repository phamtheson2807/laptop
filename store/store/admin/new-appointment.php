...
<html>
<head>
<title>Cửa hàng sửa chữa máy tính || Thêm lịch hẹn</title>
...
?>
                     ...
                     <?php } else { ?>
                      ...
                      <td><a href="view-appointment.php?viewid=<?php echo $row['bid'];?>" class="btn btn-primary">Xem</a>
<a href="new-appointment.php?delid=<?php echo $row['bid'];?>" class="btn btn-danger" onClick="return confirm('Are you sure you want to delete?')">Xóa</a></td> </tr>   <?php
$cnt=$cnt+1;
}?></tbody> </table>
					</div>
				</div>
