...
<html>
<head>
<title>Cửa hàng sửa chữa máy tính || Tìm kiếm lịch hẹn</title>
...
<body class="cbp-spmenu-push">
	...
	<div class="form-body">
							<form method="post" name="search" action="">
							 ...
							 <div class="form-group"> <label for="exampleInputEmail1" style="padding-bottom: 20px;">Tìm kiếm theo mã lịch hẹn / SDT/ Tên khách</label> <input id="searchdata" type="text" name="searchdata" required="true" class="form-control">
						
							<br>
							  <button type="submit" name="search" class="btn btn-primary btn-sm">Tìm kiếm</button> </form> 
						</div>
...
$sdata=$_POST['searchdata'];
  ...
  <h4 align="center">Kết quả  "<?php echo $sdata;?>" từ khóa </h4> 
						...
						<table class="table table-bordered"> <thead> <tr> <th>#</th> <th> STT</th> <th>Tên khách</th><th>SDT</th> <th>Ngày hẹn</th><th>Thời gian hẹn</th><th>Hành động</th> </tr> </thead> <tbody>
<?php
