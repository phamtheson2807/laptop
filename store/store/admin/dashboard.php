...
<html>
<head>
<title>Cửa hàng sữa chữa máy tính | Thống kê</title>
...
?>
					...
					<div class="col-md-4 widget states-last">
						<?php $query3=mysqli_query($con,"Select * from tblbook where Status='Đã chọn'");
$totalaccapt=mysqli_num_rows($query3);
?>
						<div class="stats-left">
							<h5>Tổng</h5>
							<h4>Lịch hẹn đã duyệt</h4>
						</div>
						<div class="stats-right">
				...
				<div class="row calender widget-shadow">
					<div class="row-one">
					<div class="col-md-4 widget">
						<?php $query4=mysqli_query($con,"Select * from tblbook where Status='Từ chối'");
$totalrejapt=mysqli_num_rows($query4);
?>
						<div class="stats-left ">
							<h5>Tổng</h5>
							<h4>Lịch hẹn đã từ chối</h4>
						</div>
						<div class="stats-right">
