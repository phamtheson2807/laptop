...
<html>
<head>
<title>Cửa hàng sữa chữa máy tính || Danh sách lịch hẹn</title>
				...
				<div class="tables">
					...
					<div class="table-responsive bs-example widget-shadow">
						<table class="table table-bordered"> <thead> <tr> <th>#</th>
							...
							<th>Thời gian hẹn</th>
							<th>Trạng thái</th>
							<th>Hành động</th> </tr> </thead> <tbody>
<?php
...
<a href="all-appointment.php?delid=<?php echo $row['bid'];?>" class="btn btn-danger" onClick="return confirm('Are you sure you want to delete?')">Xóa</a>
                                       	</td> </tr>   <?php
$cnt=$cnt+1;
}?></tbody> </table>
					</div>
