...
$y2=date("Y",$month2);
    ?>
<h4 class="header-title m-t-0 m-b-30">Báo cáo theo tháng</h4>
<h4 align="center" style="color:blue">Từ ngày <?php echo $m1."-".$y1;?> tới ngày <?php echo $m2."-".$y2;?></h4>
<hr />
...
$y2=date("Y",$year2);
 ...
 <h4 class="header-title m-t-0 m-b-30">Báo cáo bán hàng theo năm</h4>
    <h4 align="center" style="color:blue">Từ ngày<?php echo $y1;?> đến ngày<?php echo $y2;?></h4>
    <hr />
    <table class="table table-bordered">  <thead>
<tr>
<th>S.NO</th>
