...
<html>
<head>
<title>Cửa hàng sửa chữa máy tính |  Báo cáo bán hàng</title>
...
<body class="cbp-spmenu-push">
    ...
    echo $msg;
							 ...
							 <div class="form-group"> <label for="exampleInputPassword1">Loại báo cáo
							 </label><input type="radio" name="requesttype" value="mtwise" checked="true">Theo tháng
                  <input type="radio" name="requesttype" value="yrwise">Theo năm</div>
